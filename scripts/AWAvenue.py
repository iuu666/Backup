...
# 配置
# -----------------------------------------------------
SAVE_DIR = os.path.join("TG-Twilight", "AWAvenue-Ads-Rule")
...
# -----------------------------------------------------
rules = {
    "AWAvenue-Ads-Rule-Surge-RULE-SET.list": "https://github.com/TG-Twilight/AWAvenue-Ads-Rule/blob/main/Filters/AWAvenue-Ads-Rule-Surge-RULE-SET.list",
    "AWAvenue-Ads-Rule-QuantumultX.list": "https://github.com/TG-Twilight/AWAvenue-Ads-Rule/blob/main/Filters/AWAvenue-Ads-Rule-QuantumultX.list",
}
