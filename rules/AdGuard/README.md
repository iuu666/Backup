...
> 最后更新：2026-06-15 13:41:19

## 规则列表

| 文件名 | 作用 | 7天前 | 昨天 | 今天 | 趋势 |
|--------|------|-------|------|------|------|
| base-filter | 基础广告过滤 | 61,440 | 58,196 | 58,499 | 📈 +0.5% |
| tracking-protection | 隐私追踪保护 | 84,592 | 84,641 | 84,641 | ➡️ 持平 |
| chinese-filter | 中文网站广告过滤 | 6,375 | 6,452 | 6,463 | 📈 +0.2% |
| social-media | 社交媒体组件屏蔽 | 49 | 49 | 49 | ➡️ 持平 |
| dns-filter | DNS 层广告拦截 | 160,886 | 157,729 | 158,019 | 📈 +0.2% |
| annoyances | 烦人元素合集（包含以下子项） | 862 | 862 | 862 | ➡️ 持平 |
| annoyances-cookie-notices | &nbsp;&nbsp;&nbsp;├─ Cookie 通知屏蔽 | 180 | 180 | 180 | ➡️ 持平 |
| annoyances-popups | &nbsp;&nbsp;&nbsp;├─ 弹窗屏蔽 | 419 | 419 | 419 | ➡️ 持平 |
| annoyances-mobile-app-banners | &nbsp;&nbsp;&nbsp;├─ 移动端横幅屏蔽 | 3 | 3 | 3 | ➡️ 持平 |
| annoyances-widgets | &nbsp;&nbsp;&nbsp;├─ 网页挂件屏蔽 | 248 | 248 | 248 | ➡️ 持平 |
