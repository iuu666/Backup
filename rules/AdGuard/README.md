...
> 最后更新：2026-08-30 13:43:18

## 规则列表

| 文件名 | 作用 | 7天前 | 昨天 | 今天 | 趋势 |
|--------|------|-------|------|------|------|
| base-filter | 基础广告过滤 | 55,298 | 55,914 | 56,180 | 📈 +0.5% |
| tracking-protection | 隐私追踪保护 | 106,303 | 106,343 | 106,343 | ➡️ 持平 |
| chinese-filter | 中文网站广告过滤 | 6,202 | 6,272 | 6,285 | 📈 +0.2% |
| social-media | 社交媒体组件屏蔽 | 49 | 49 | 49 | ➡️ 持平 |
| dns-filter | DNS 层广告拦截 | 176,912 | 177,743 | 178,045 | 📈 +0.2% |
