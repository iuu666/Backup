...
> 最后更新：2026-06-02 13:13:59

## 规则列表

| 文件名 | 作用 | 7天前 | 昨天 | 今天 | 趋势 |
|--------|------|-------|------|------|------|
| base-filter | 基础广告过滤 | - | 65,003 | 65,291 | 📈 +0.4% |
| tracking-protection | 隐私追踪保护 | - | 84,580 | 84,582 | 📈 +0.0% |
| chinese-filter | 中文网站广告过滤 | - | 6,299 | 6,309 | 📈 +0.2% |
| social-media | 社交媒体组件屏蔽 | - | 49 | 49 | ➡️ 持平 |
| dns-filter | DNS 层广告拦截 | - | 164,369 | 164,669 | 📈 +0.2% |
| annoyances | 烦人元素合集（包含以下子项） | - | 861 | 862 | 📈 +0.1% |
...
| annoyances-widgets | &nbsp;&nbsp;&nbsp;├─ 网页挂件屏蔽 | - | 247 | 248 | 📈 +0.4% |
