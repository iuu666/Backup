...
> 最后更新：2026-09-05 12:52:55

## 规则列表

| 文件名 | 作用 | 7天前 | 昨天 | 今天 | 趋势 |
|--------|------|-------|------|------|------|
| base-filter | 基础广告过滤 | 55,914 | 57,003 | 57,296 | 📈 +0.5% |
| tracking-protection | 隐私追踪保护 | 106,343 | 106,354 | 106,364 | 📈 +0.0% |
| chinese-filter | 中文网站广告过滤 | 6,272 | 6,339 | 6,347 | 📈 +0.1% |
| social-media | 社交媒体组件屏蔽 | 49 | 49 | 49 | ➡️ 持平 |
| dns-filter | DNS 层广告拦截 | 177,743 | 178,935 | 179,265 | 📈 +0.2% |
| annoyances | 烦人元素合集（包含以下子项） | 870 | 872 | 873 | 📈 +0.1% |
...
| annoyances-widgets | &nbsp;&nbsp;&nbsp;├─ 网页挂件屏蔽 | 252 | 252 | 253 | 📈 +0.4% |
