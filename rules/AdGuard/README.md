...
> 最后更新：2026-06-07 13:09:54

## 规则列表

| 文件名 | 作用 | 7天前 | 昨天 | 今天 | 趋势 |
|--------|------|-------|------|------|------|
| base-filter | 基础广告过滤 | 64,708 | 60,851 | 61,147 | 📈 +0.5% |
| tracking-protection | 隐私追踪保护 | 84,580 | 84,592 | 84,592 | ➡️ 持平 |
| chinese-filter | 中文网站广告过滤 | 6,289 | 6,357 | 6,367 | 📈 +0.2% |
| social-media | 社交媒体组件屏蔽 | 49 | 49 | 49 | ➡️ 持平 |
| dns-filter | DNS 层广告拦截 | 164,049 | 160,274 | 160,583 | 📈 +0.2% |
