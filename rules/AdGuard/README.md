...
> 最后更新：2026-07-07 12:34:37

## 规则列表

| 文件名 | 作用 | 7天前 | 昨天 | 今天 | 趋势 |
|--------|------|-------|------|------|------|
| base-filter | 基础广告过滤 | 52,397 | 54,232 | 53,660 | 📉 -1.1% |
| tracking-protection | 隐私追踪保护 | 84,675 | 84,690 | 84,693 | 📈 +0.0% |
| chinese-filter | 中文网站广告过滤 | 6,359 | 6,413 | 6,422 | 📈 +0.1% |
| social-media | 社交媒体组件屏蔽 | 49 | 49 | 49 | ➡️ 持平 |
| dns-filter | DNS 层广告拦截 | 152,507 | 154,460 | 153,924 | 📉 -0.3% |
| annoyances | 烦人元素合集（包含以下子项） | 867 | 867 | 867 | ➡️ 持平 |
