...
> 最后更新：2026-05-29 00:27:48

| 规则文件 | 7天前 | 昨天 | 今天 | 趋势 |
|---------|-------|------|------|------|
| base-filter.txt | - | - | 64,041 | - |
| tracking-protection.txt | - | - | 84,574 | - |
| chinese-filter.txt | - | - | 6,266 | - |
| social-media.txt | - | - | 49 | - |
| dns-filter.txt | - | - | 163,378 | - |
| annoyances.txt | - | - | 861 | - |
| annoyances-cookie-notices.txt | - | - | 180 | - |
| annoyances-popups.txt | - | - | 419 | - |
| annoyances-mobile-app-banners.txt | - | - | 3 | - |
| annoyances-widgets.txt | - | - | 247 | - |
| annoyances-other.txt | - | - | 16 | - |
