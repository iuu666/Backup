...
> 最后更新：2026-06-03 13:29:37

## 规则列表

| 文件名 | 作用 | 7天前 | 昨天 | 今天 | 趋势 |
|--------|------|-------|------|------|------|
| base-filter | 基础广告过滤 | - | 65,291 | 59,952 | 📉 -8.2% |
| tracking-protection | 隐私追踪保护 | - | 84,582 | 84,587 | 📈 +0.0% |
| chinese-filter | 中文网站广告过滤 | - | 6,309 | 6,322 | 📈 +0.2% |
| social-media | 社交媒体组件屏蔽 | - | 49 | 49 | ➡️ 持平 |
| dns-filter | DNS 层广告拦截 | - | 164,669 | 159,298 | 📉 -3.3% |
| annoyances | 烦人元素合集（包含以下子项） | - | 862 | 862 | ➡️ 持平 |
...
| annoyances-widgets | &nbsp;&nbsp;&nbsp;├─ 网页挂件屏蔽 | - | 248 | 248 | ➡️ 持平 |
