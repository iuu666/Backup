...
> 最后更新：2026-05-29 00:38:03

## 规则列表

| 文件名 | 作用 | 7天前 | 昨天 | 今天 | 趋势 |
|--------|------|-------|------|------|------|
| base-filter.txt | 基础广告过滤 | - | - | 64,041 | - |
| tracking-protection.txt | 隐私追踪保护 | - | - | 84,574 | - |
| chinese-filter.txt | 中文网站专用 | - | - | 6,266 | - |
| social-media.txt | 社交媒体屏蔽 | - | - | 49 | - |
| dns-filter.txt | 恶意域名屏蔽 | - | - | 163,378 | - |
| annoyances.txt | 烦人元素合集（包含以下子项） | - | - | 861 | - |
| annoyances-cookie-notices.txt | &nbsp;&nbsp;&nbsp;├─ Cookie 通知屏蔽 | - | - | 180 | - |
| annoyances-popups.txt | &nbsp;&nbsp;&nbsp;├─ 弹窗屏蔽 | - | - | 419 | - |
| annoyances-mobile-app-banners.txt | &nbsp;&nbsp;&nbsp;├─ 移动端横幅屏蔽 | - | - | 3 | - |
| annoyances-widgets.txt | &nbsp;&nbsp;&nbsp;├─ 网页挂件屏蔽 | - | - | 247 | - |
| annoyances-other.txt | &nbsp;&nbsp;&nbsp;└─ 其他烦人元素 | - | - | 16 | - |
